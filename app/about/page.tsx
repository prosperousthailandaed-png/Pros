  ...
  return (
    <div className="about">
      ...
      <section className="finale">
        <div className="narrow reveal">
          <div className="big-r">PROSPEROUS</div>
          <h3>นิยามความหมายชื่อของบริษัท</h3>
          <p className="quote">
            "เราไม่ได้มุ่งหวังเพียงแค่ความเจริญรุ่งเรืองในทางธุรกิจเท่านั้น แต่{' '}
            <span className="em-brand">PROSPEROUS</span> ของเรา คือการทำให้<br />{' '}
            <span className="em">'ชีวิตและความปลอดภัยของคนในสังคม เจริญงอกงามและมั่นคงขึ้น'</span>{' '}
            <br />ด้วยนวัตกรรมการช่วยชีวิตและการส่งต่อความรู้ที่ถูกต้อง เพื่อให้ทุกหัวใจได้มีโอกาสเติบโตและแข็งแรงต่อไป"
          </p>
        </div>
      </section>
    </div>
