      ...
      <section>
        <div className="narrow">
          ...
          <div className="mission">
            <div className="m-item reveal"><div className="m-num">1</div><h4>สรรหานวัตกรรมทางการแพทย์ระดับโลก</h4><div className="en">World-Class Innovation</div><p>มุ่งมั่นเป็นตัวแทนจำหน่ายอุปกรณ์กายภาพและอุปกรณ์กู้ชีพมาตรฐานสากล อาทิ เครื่องกระตุกหัวใจไฟฟ้าอัตโนมัติ (AED) แบรนด์ Acoresmed และเครื่องนวดหัวใจอัตโนมัติ (Auto CPR) จาก Michigan Instrument เพื่อให้คนไทยเข้าถึงเทคโนโลยีช่วยชีวิตที่ดีที่สุด</p></div>
            <div className="m-item reveal"><div className="m-num">2</div><h4>ยกระดับความรู้สู่มาตรฐานสากล</h4><div className="en">Standardized Training</div><p>ส่งเสริมและเปิดหลักสูตรฝึกอบรมการช่วยชีวิตขั้นพื้นฐาน (CPR &amp; AED) ที่ได้มาตรฐานสากลของสมาคมแพทย์โรคหัวใจแห่งอเมริกา (AHA) เพื่อสร้างผู้ปฏิบัติการที่เชี่ยวชาญและมั่นใจในสถานการณ์จริง</p></div>
            <div className="m-item reveal"><div className="m-num">3</div><h4>พิทักษ์ความปลอดภัยทางน้ำ</h4><div className="en">Maritime Rescue Excellence</div><p>สนับสนุนและขับเคลื่อน ชมรมกู้ภัยทางน้ำทางทะเล ภายใต้การบริหารงานโดย นาวาตรี ดร.ฐาพล สมสกุล ในการส่งต่อองค์ความรู้และทักษะการช่วยชีวิตทางน้ำชั้นสูงในภาวะฉุกเฉิน</p></div>
            <div className="m-item reveal"><div className="m-num">4</div><h4>ขับเคลื่อนสังคมและลดความสูญเสีย</h4><div className="en">Social Responsibility &amp; CSR</div><p>มุ่งมั่นดำเนินกิจกรรมเพื่อสังคม (CSR) เป็นแกนกลางระดมงบประมาณและทรัพยากรจากภายนอก เพื่อจัดฝึกอบรมการกู้ชีพและการป้องกันอุบัติภัยทางน้ำให้แก่หน่วยงานทหาร ทหารเรือ และหน่วยงานภาครัฐ ลดอัตราการสูญเสียจากการจมน้ำอย่างเป็นรูปธรรม</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="mist">
        <div className="wrap">
          <div className="reveal" style={{ textAlign: 'center' }}>
            ...
            <div className="prosper-word"><span>P</span><span>R</span><span>O</span><span>S</span><span>P</span><span>E</span><span>R</span></div>
          </div>
          <div className="values">
            <div className="v-card reveal"><div className="v-letter">P</div><div><div className="en">Professionalism</div><h4>ความเป็นมืออาชีพ</h4><p>เราส่งมอบเฉพาะอุปกรณ์การแพทย์ระดับโลก เช่น AED แบรนด์ Acoresmed และ Auto CPR จาก Michigan ควบคู่ไปกับการฝึกอบรมตามมาตรฐานสากล AHA</p></div></div>
            <div className="v-card reveal"><div className="v-letter">R</div><div><div className="en">Rescue Excellence</div><h4>ความเป็นเลิศด้านการกู้ชีพและกู้ภัย</h4><p>เราไม่เพียงแต่สอนทฤษฎี แต่เราสร้าง “ทักษะที่ใช้ได้จริงในวิกฤต” ทั้งบนบกและทางน้ำ</p></div></div>
            <div className="v-card reveal"><div className="v-letter">O</div><div><div className="en">Outreach for Society</div><h4>การเข้าถึงและช่วยเหลือสังคม</h4><p>เราขยายโอกาสการเข้าถึงอุปกรณ์และความรู้ไปยังพื้นที่หรือหน่วยงานที่ขาดแคลน ผ่านกิจกรรม CSR</p></div></div>
            <div className="v-card reveal"><div className="v-letter">S</div><div><div className="en">Safety First</div><h4>ความปลอดภัยเป็นหัวใจสูงสุด</h4><p>ทุกผลิตภัณฑ์ ทุกหลักสูตร และทุกการปฏิบัติงานของเรา มีเป้าหมายเดียวคือการลดการสูญเสีย และป้องกันการเกิดอุบัติภัยซ้ำซ้อน</p></div></div>
            <div className="v-card reveal"><div className="v-letter">P</div><div><div className="en">Passion for Life</div><h4>ความมุ่งมั่นเพื่อคุณค่าของทุกชีวิต</h4><p>เราทำงานด้วยใจที่เชื่อว่า “ทุกวินาทีชีวิตมีคำว่าโอกาสซ่อนอยู่” และเราจะไม่ยอมแพ้ต่อข้อจำกัดใด ๆ</p></div></div>
            <div className="v-card reveal"><div className="v-letter">E</div><div><div className="en">Education &amp; Empowerment</div><h4>การศึกษาและการสร้างพลัง</h4><p>เราเชื่อในการส่งต่อองค์ความรู้ที่ถูกต้องเพื่อขจัดความกลัว และเปลี่ยนคนธรรมดาให้กลายเป็น “ผู้ช่วยชีวิต”</p></div></div>
            <div className="v-card reveal" style={{ gridColumn: '1/-1' }}><div className="v-letter">R</div><div><div className="en">Responsibility &amp; Reliability</div><h4>ความรับผิดชอบและความน่าเชื่อถือ</h4><p>เราเป็นองค์กรที่สังคมและหน่วยงานภาครัฐ / ความมั่นคง มอบความไว้วางใจให้ดูแลชีวิตและความปลอดภัย</p></div></div>
          </div>
        </div>
      </section>
